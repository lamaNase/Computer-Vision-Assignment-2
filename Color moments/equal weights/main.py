...
def cbir(queryset_path, dataset_path, threshold):
    ...
    for queryImage in os.listdir(queryset_path):
        ...
        if (queryImage.lower().endswith(('.jpg', '.jpeg', '.png'))):
            ...
            query_features = calculate_color_moments(query_image,(1.0,1.0,1.0))
            ...
            for image_file in os.listdir(dataset_path):
                if image_file.lower().endswith(('.jpg', '.jpeg', '.png')):
                    ...
                    db_features = calculate_color_moments(image,(1.0,1.0,1.0))
...
quiers_path = "quires_set"

threshold = input("Enter the threshold: ")
threshold = float(threshold)
cbir(quiers_path,dataset_path,threshold)
